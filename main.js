...
class IndemnifiedScene {
  ...
  async initCatWindow() {
    ...
    // Create an abstract, algorithmic cat using SVG
    ...
    eyeAnimation.setAttribute("dur", "2s");
    ...
    for (let i = 0; i < 10; i++) {
      ...
      animation.setAttribute("dur", `${1 + Math.random() * 2}s`);
